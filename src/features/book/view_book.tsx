...
function ViewBook(props:any) {
    ...
    useEffect(()=> {
      ...
      setYearPublished(props.bookData.yearPublished)
      setTotalCount(props.bookData.totalCount)
      console.log(props.bookData.totalCount)
      setAvailableCount(props.bookData.availableCount)
    }, [props.bookData]);
    ...
    return (
      <>
        ...
        <Icon onClick={bookListPage} align="right" width="32" height="32" icon="bi:skip-backward-circle"/> Back to Book list
        <div className="row no-gutters">
            <Image thumbnail={true} className="col-md-2 col-lg-4 square border border-dark"></Image>
            <div className="col-md-10 col-lg-8">
                <div className="d-flex flex-column">
                    <div className="d-flex flex-row justify-content-between align-items-center p-5 bg-dark text-white">
                        <h3 className="display-5">{title}</h3><i className="fa fa-facebook"></i><i className="fa fa-google"></i><i className="fa fa-youtube-play"></i><i className="fa fa-dribbble"></i><i className="fa fa-linkedin"></i></div>
                    ...
                    <div className="p-3 bg-black text-white">
                        Total Copies &nbsp;&nbsp; : &nbsp;&nbsp; {props.bookData.totalCount}
                    </div>
                    <div className="p-3 bg-black text-white">
                        Avaiable Copies &nbsp;&nbsp; : &nbsp;&nbsp; {props.bookData.availableCount}
                    </div>
